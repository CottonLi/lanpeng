...
public class AlarmController extends BaseController
{
    ...
    {
        startPage();
        List<AlarmRule> list = alarmService.selectAlarmRuleList();
    ...
    @PostMapping("/rule")
    public AjaxResult add(@Validated @RequestBody AlarmRule alarmRule)
    {
    ...
    @PutMapping("/rule")
    public AjaxResult edit(@Validated @RequestBody AlarmRule alarmRule)
    {
     ...
     */
    @GetMapping("/list")
    public TableDataInfo alarmlist(@Validated @RequestBody AlarmCondition alarmCondition)
    {
        startPage();
        List<Alarm> list = alarmService.selectAlarmList(alarmCondition);
        return getDataTable(list);
    }
    ...
    @Log(title = "告警", businessType = BusinessType.INSERT)
    @PostMapping
    public AjaxResult addalarm(@Validated @RequestBody Alarm alarm)
    {
        //message.setCreateBy(getUsername());
    ...
    @Log(title = "告警", businessType = BusinessType.UPDATE)
    @PutMapping
    public AjaxResult editalarm(@Validated @RequestBody Alarm alarm)
    {
        //message.setUpdateBy(getUsername());
